...
function(){return FastClick.prototype.onTouchEnd.apply(c,arguments)};this.onTouchCancel=function(){return FastClick.prototype.onTouchCancel.apply(c,arguments)};FastClick.notNeeded()||(this.deviceIsAndroid&&(a.addEventListener("mouseover",this.onMouse,!0),a.addEventListener("mousedown",this.onMouse,!0),a.addEventListener("mouseup",this.onMouse,!0)),a.addEventListener("click",this.onClick,!0),a.addEventListener("touchstart",this.onTouchStart,!1),a.addEventListener("touchend",this.onTouchEnd,!1),a.addEventListener("touchcancel",
...
FastClick.prototype.needsClick=function(a){var b=a.nodeName.toLowerCase();if("button"===b||"input"===b){if(this.deviceIsIOS&&"file"===a.type||a.disabled)return!0}else if("label"===b||"video"===b)return!0;return/\bneedsclick\b/.test(a.className)};
